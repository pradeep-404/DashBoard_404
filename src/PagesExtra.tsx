      ...
      <div className="card">
        <div className="ctitle">
          ...
          <div className="cf">
            ...
            <label>Employee</label><FilterSelect value={emp} onChange={v=>{setEmp(v); setPg(0);}} options={[{value:'all',label:'All'}, ...Array.from(new Set(entries.map(x=>x.employee))).map(x=>({value:x,label:x}))]} />
            <div className="fsep"></div>
            <label>Project</label><FilterSelect value={proj} onChange={v=>{setProj(v); setPg(0);}} options={[{value:'all',label:'All'}, ...Array.from(new Set(entries.map(x=>x.project))).map(x=>({value:x,label:x}))]} />
          </div>
        </div>
      ...
      <div className="card">
        <div className="ctitle">
          ...
          <div className="cf">
            ...
            <FilterSelect value={empFilter} onChange={v=>{setEmpFilter(v); setPg(0);}} options={[{value:'all',label:'All'}, ...Array.from(new Set(entries.map(x=>x.employee))).map(e=>({value:e,label:e}))]} />
            <div className="fsep"></div>
            <label>Status</label>
