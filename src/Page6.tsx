      ...
      <div className="card" style={{ padding: '10px' }}>
        <div className="ctitle">
          ...
          <div className="cf">
            ...
            <label>Project</label>
            <FilterSelect value={projFilter} onChange={setProjFilter} options={[{value:'all',label:'All'}, ...Array.from(new Set<string>(entries.map(x=>x.project))).map(x=>({value:x,label:x}))]} />
          </div>
        </div>
